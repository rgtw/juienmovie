...
const DetailPanel: React.FC<DetailPanelProps> = ({
  ...
  const fetchGalleryImages = async () => {
    ...
    try {
      ...
      console.error('獲取照片牆失敗:', err);
      setGalleryError(err instanceof Error ? err.message : '獲取照片牆失敗');
    } finally {
    ...
    const fetchTmdbData = async () => {
      ...
      if (searchData.results && searchData.results.length > 0) {
        ...
        setDetailData({
          ...
          duration: detailResult.runtime ? `${detailResult.runtime}分鐘` : undefined,
  ...
  const galleryBody = (
    <div ref={galleryScrollRef} className="flex-1 overflow-y-auto overflow-x-hidden p-4">
      ...
      {!galleryLoading && !galleryError && galleryImages.length === 0 && (
        <div className="text-center py-12 text-gray-500 dark:text-gray-400">暫無圖片</div>
      )}
            ...
            <div className="p-6">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between gap-3 flex-wrap">
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-500 dark:text-gray-400">數據來源:</span>
          ...
          {!loading && !error && detailData && (
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                {detailData.status && (
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">狀態</h4>
