...
export default function SmartRecommendations({
  ...
  const fetchDoubanRecommendations = useCallback(async () => {
    ...
    try {
      ...
      console.error('獲取豆瓣推薦失敗:', err);
      setError(err instanceof Error ? err.message : '獲取推薦失敗');
    } finally {
      setLoading(false);
    }
  }, [doubanId]);
