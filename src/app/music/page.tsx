...
export default function MusicPage() {
  ...
  const loadPlaylists = async (source: string) => {
    ...
    try {
      ...
      if (boardsResponse.ok && boardsData.success) {
        ...
        console.error('加載排行榜失敗:', boardsData);
        setPlaylists([]);
      }
    } catch (error) {
  ...
  const handlePlayAllCurrentSongs = async () => {
    ...
    try {
      ...
      setToast({
        message: `已開始播放 ${currentPlaylistTitle || '當前歌單'}`,
        type: 'success',
        onClose: () => setToast(null),
      });
    } catch (error) {
      console.error('排行榜播放全部失敗:', error);
      setToast({
        message: '播放全部失敗',
        type: 'error',
        onClose: () => setToast(null),
  ...
  const handlePlayAllPlaylist = async () => {
    ...
    try {
      ...
      setToast({
        message: `已將 ${userPlaylistSongs.length} 首歌曲添加到播放列表`,
        type: 'success',
        onClose: () => setToast(null),
      });
    } catch (error) {
      console.error('播放全部失敗:', error);
      setToast({
        message: '播放全部失敗',
        type: 'error',
        onClose: () => setToast(null),
  ...
  useEffect(() => {
    ...
    const ensureAnalyser = async () => {
      try {
        ...
        console.warn('初始化頻譜分析器失敗，將使用模擬動畫:', error);
      }
    };
        ...
        <div className="w-full mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-4 py-3">
          <div className="flex items-center justify-between md:justify-start md:gap-6 w-full md:w-auto">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-lg text-white">音樂</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-1">
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-white/10">
                  <h2 className="text-lg font-bold mb-4">歌單列表</h2>
                ...
                {selectedUserPlaylist ? (
                  <div className="bg-zinc-800/50 rounded-xl p-4 border border-white/10">
                    ...
                    {loadingUserPlaylistSongs ? (
                      ...
                      <div className="text-center py-8 text-zinc-400">歌單為空</div>
                    ) : (
                      <div className="space-y-2">
            ...
            <div className="flex items-center justify-between gap-4 mt-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={toggleMode}
                  className="text-zinc-500 hover:text-white transition-colors"
                  title={playMode === 'loop' ? '列表循環' : playMode === 'single' ? '單曲循環' : '隨機播放'}
                >
                  {playMode === 'loop' && (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div ref={lyricsContainerRef} className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                {lyrics.length > 0 ? (
                  ...
                  <div className="text-center space-y-4 pt-10 md:pt-16 lg:pt-20">
                    <p className="text-zinc-500 text-sm md:text-base">暫無歌詞</p>
                    <p className="text-zinc-600 text-xs md:text-sm">純音樂或歌詞獲取失敗</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6">
              {playlist.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-zinc-500 text-sm">播放列表為空</p>
                  <p className="text-zinc-600 text-xs mt-2">播放歌曲後會自動添加到列表</p>
                </div>
              )}
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="p-4 border-b border-white/10">
              <h3 className="text-lg font-bold text-white text-center">選擇音質</h3>
            </div>
            ...
            <div className="p-4 space-y-2">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-white font-medium">標準音質</div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-white font-medium">高品質 HQ</div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-white font-medium">無損音質 SQ</div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-white font-medium">Hi-Res音質 HR</div>
      ...
      {showSourceMenu && (
        <div className="md:hidden fixed inset-0 z-[90]">
          ...
          <div className="absolute inset-x-0 bottom-0 rounded-t-3xl border-t border-white/10 bg-zinc-950/98 px-4 pb-6 pt-4 shadow-2xl">
            ...
            <div className="mb-3 px-1 text-sm font-medium text-white">切換音源</div>
            <div className="space-y-2">
              {musicSources.map((source) => {
